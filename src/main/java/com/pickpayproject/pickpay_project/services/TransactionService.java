...
import com.pickpayproject.pickpay_project.dtos.TransactionDTO;
import com.pickpayproject.pickpay_project.repositories.TransactionRepository;
...
public class TransactionService {
    ...
    public boolean authorizeTransaction(User sender, BigDecimal value) {
        ...
        if (authorizationResponse.getStatusCode() == HttpStatus.OK) {
            String message = authorizationResponse.getBody();
